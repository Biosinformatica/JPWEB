...
public class Email {
    ...
    public static void main(String[] args){
        String clave = "soluciones2013";
        Email e = new Email("biosinformaticajujuy@gmail.com",clave,"martincho666@hotmail.com","Prueba Módulo de Correo","Prueba del tutorial para mandar un email");
        if (e.sendMail()){
            JOptionPane.showMessageDialog(null, "Email enviado correctamente");
        }
        else{
            JOptionPane.showMessageDialog(null, "Error en envío de correo");
        }
    }
}
