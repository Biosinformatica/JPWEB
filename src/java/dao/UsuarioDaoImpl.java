...
public class UsuarioDaoImpl implements UsuarioDao{
    ...
    public List<Usuario> findAll() {
        ...
        Session sesion = HibernateUtil.getSessionFactory().getCurrentSession();
        String sql = "FROM Usuario u inner join fetch u.rol left join fetch u.sucursal";
        try {
            sesion.beginTransaction();
    ...
    public boolean update(Usuario usuario) {
        ...
        try {
            ...
            usuariodb.setApeliido(usuario.getApeliido());
            usuariodb.setEmail(usuario.getEmail());
            usuariodb.setUsuario(usuario.getUsuario());
            usuariodb.setRol(usuario.getRol());
            usuariodb.setSucursal(usuario.getSucursal());
